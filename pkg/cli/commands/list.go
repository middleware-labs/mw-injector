...
// 	// Filter for systemd processes only
// 	var systemdProcesses []discovery.JavaProcess
// 	for _, proc := range processes {
// 		if c.detectDeploymentType(&proc) == "systemd" && !proc.IsTomcat() {
...
// 	// Segregate processes
// 	var dockerProcs []discovery.JavaProcess
...
// 		} else {
// 			dockerProcs = append(dockerProcs, proc)
// 		}
// 	}
...
// 	fmt.Printf("╔══════════════════════════════════════════════════════════════════════╗\n")
// 	fmt.Printf("║                         🐱 TOMCAT INSTANCES                          ║\n")
// 	fmt.Printf("╚══════════════════════════════════════════════════════════════════════╝\n\n")

// 	if len(processes) == 0 {
// 		fmt.Println("  No Tomcat instances found")
// 		fmt.Println()
// 		return
// 	}

// 	fmt.Printf("  Found %d Tomcat instance(s)\n\n", len(processes))
...
// 	fmt.Printf("  Found %d systemd service(s)\n\n", len(processes))
